        ...
        <ModalBody>
          <form className="form-group" onSubmit={handleSubmit(onsubmit)}>
            ...
            <div className="contenedor-boton-modal-dentro">
              <button type="submit" className="btn btn-success" onClick={editar}>Editar</button>
            </div>
          </form>
          <div className="contenedor-boton-modal-fuera">
              <button className="btn btn-danger boton-cancelar" onClick={cerrarFormulario}>Cancelar</button>
          </div>
        </ModalBody>
      </Modal>
    )
