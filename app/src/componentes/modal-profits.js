               ...
               <div className='modal-body-container'>
                   <div className='dates-container'>
                        ...
                        <div className='date-container-until'>
                            <label>Hasta:</label>
                            <input className={errors.dateUntilError ? "date-error" : "date"} type='date' defaultValue={actualityDate.getFullYear() + '-' + ('00' + (actualityDate.getMonth()+1)).slice(-2) + '-' + ('00' +  actualityDate.getUTCDate()).slice(-2)} {...register('dateUntil',{
                                shouldUnregister:true,
