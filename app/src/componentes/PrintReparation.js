          ...
          <div className="repair-data-container">
            <div className="header-container-print">
              <div className="title-and-adress">
                <h5  style={{ marginBottom: '5px', fontSize: '14px'}}>Red Point</h5>
